<x-template title="happy birthday Suzu">
    ...
    <img src="{{ asset('storage/img/pic-01.png') }}" alt="pic-01" class="yes-drop drag-drop object-cover w-[30dvw] h-[30dvw]">
    <img src="{{ asset('storage/img/pic-02.png') }}" alt="pic-02" class="yes-drop drag-drop object-cover w-[30dvw] h-[30dvw]">


    <div id="inner-dropzone" class="dropzone">ドロップエリア</div>
</x-template>
